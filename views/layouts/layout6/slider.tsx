          ...
          <Row className="row">
              ...
              <div className="slide-1 no-arrow ">
                <div className="slide-1 no-arrow ">
                  <Slider {...settings}>
                    <div>
                      <div className="slider-banner slide-banner-5 ">
                        <div className="slider-img">
                          <Media
                            src="/images/layout-6/slider/2.1.jpg"
                            className="bg-img"
                            alt="slider"
                          />
                          <ul className="layout6-slide-2">
                            <li>
                              <Media
                                src="/images/layout-6/slider/2.2.png"
                                className="img-fluid"
                                alt="slider"
                              />
                            </li>
                            <li>
                              <Media
                                src="/images/layout-6/slider/2.3.png"
                                className="img-fluid"
                                alt="slider"
                              />
                            </li>
                            <li>
                              <Media
                                src="/images/layout-6/slider/2.4.png"
                                className="img-fluid"
                                alt="slider"
                              />
                            </li>
                            <li>
                              <Media
                                src="/images/layout-6/slider/2.5.png"
                                className="img-fluid"
                                alt="slider"
                              />
                            </li>
                    ...
                    <div>
                      <div
                        className="slider-banner slide-banner-5"
                        ...
                        <div className="slider-img">
                          <ul className="layout6-slide-1">
                            <li style={elemOne} id="img-1">
                              <Media
                                src="/images/layout-6/slider/1.1.png"
                                className="img-fluid"
                                alt="slider"
                              />
                            </li>
            ...
            <Col xl="2" sm="3" className="ps-0 offer-banner">
              <div className="offer-banner-img">
                <Media
                  src="/images/layout-6/collection-banner/4.jpg"
                  alt="offer-banner"
                  className="img-fluid"
                />
              </div>
