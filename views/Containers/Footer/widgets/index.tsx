                ...
                <Col lg="4" md="12">
                  <div className="footer-left">
                    ...
                    <div className="footer-detail">
                      <p>
                      Your GoldBit website is an exquisite treasure trove of information and resources. It gleams with elegance and offers a wealth of knowledge about gold and related topics.
                      </p>
                                ...
                                <div className="footer-contant">
                                  <ul className="contact-list">
                                    <li>
                                      ...
                                      <span>
                                        gold bit store <br /> <span> canada-123456789 </span>
                                      </span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <i className="fa fa-envelope-o"></i>
                                      <span>email us:ssuddin260@gmail.com</span>
                                    </li>
                                    <li>
          ...
          <Row>
            <Col xs="12">
              <div className="sub-footer-contain">
                <p>
                  <span>2023 - 24 </span>powered by Autotelematics
                </p>
              </div>
            </Col>
          </Row>
